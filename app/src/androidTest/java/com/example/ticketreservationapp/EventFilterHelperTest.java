...
/**
 * Tests for EventFilterHelper class
 * User Story: Search and Filter System for Events by Date, Location, and Category
 * 
 * Preconditions:
...
public class EventFilterHelperTest {
    ...
    public void applyFilters_withPartialSearchQuery_findsMatchingEvents() {
        ...
        assertEquals(2, result.size()); // Basketball and Football
    }
    ...
    public void applyFilters_withLocation_filtersEventsByVenue() {
        ...
        assertEquals(2, result.size()); // Central Park and Madison Square Garden
    }
    ...
    public void applyFilters_withConflictingFilters_returnsNoEvents() {
        filterHelper.setSelectedCategory("Music");
        filterHelper.setSelectedLocation("Los Angeles"); // No music events in LA
        List<Event> result = filterHelper.applyFilters();
    ...
    public void getAllLocations_returnsAllUniqueLocations() {
        ...
        assertTrue(locations.contains("AMC Theatre, Los Angeles"));
        assertTrue(locations.contains("Blue Note, Chicago"));
        assertTrue(locations.contains("MetLife Stadium, New Jersey"));
        assertTrue(locations.contains("Convention Center, San Francisco"));
    }
    ...
    public void getAllDates_returnsAllUniqueDates() {
        ...
        assertTrue(dates.contains("04/10/2026"));
        assertTrue(dates.contains("04/18/2026"));
        assertTrue(dates.contains("04/25/2026"));
        assertTrue(dates.contains("04/12/2026"));
    }
